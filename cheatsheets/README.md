...
| Fichero | Herramienta | Uso |
|---|---|---|
| `NmapCheatSheet.txt` | Nmap | Descubrimiento de hosts, puertos, servicios y vulnerabilidades |
| `NetCatCheatSheet.txt` | Netcat | Listeners, reverse shells y transferencia de ficheros |
...
nano HydraCheatSheet.txt
```

---
*Autor: D1n0 — U-TAD Hacking Ético 2025/26*
